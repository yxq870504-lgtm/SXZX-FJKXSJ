...
async function renderMap(){
  ...
  document.getElementById('rankCopy').innerHTML=`<span>${grade}</span>在班学员所在省份top5：<br>${top5.map(x=>x.short).join(' > ')}`;
